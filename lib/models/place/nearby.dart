import 'package:flutter_travel_helper/models/place/geometry_model.dart';
...
class Nearby {
  ...
  Nearby.fromJson(Map<String, dynamic> json) {
    ...
    photos = json['photos'] != null ? (json['photos'] as List).map((e) => Photos.fromJson(e)).toList() : null;
...
class Photos {
  ...
  Photos.fromJson(Map<String, dynamic> json) {
    height = json['height'];
    htmlAttributions = json['html_attributions'] != null ? List<String>.from(json['html_attributions']) : null;
